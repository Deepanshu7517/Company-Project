 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class G_{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((e,t)=>{this.resolve=e,this.reject=t})}wrapCallback(e){return(t,r)=>{t?this.reject(t):this.resolve(r),typeof e=="function"&&(this.promise.catch(()=>{}),e.length===1?e(t):e(t,r))}}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class py{constructor(e,t){this.name=e,this.container=t,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const t=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(t)){const r=new G_;if(this.instancesDeferred.set(t,r),this.isInitialized(t)||this.shouldAutoInitialize())try{const i=this.getOrInitializeService({instanceIdentifier:t});i&&r.resolve(i)}catch{}}return this.instancesDeferred.get(t).promise}getImmediate(e){const t=this.normalizeInstanceIdentifier(e?.identifier),r=e?.optional??!1;if(this.isInitialized(t)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:t})}catch(i){if(r)return null;throw i}else{if(r)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(gy(e))try{this.getOrInitializeService({instanceIdentifier:Gn})}catch{}for(const[t,r]of this.instancesDeferred.entries()){const i=this.normalizeInstanceIdentifier(t);try{const s=this.getOrInitializeService({instanceIdentifier:i});r.resolve(s)}catch{}}}}clearInstance(e=Gn){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(t=>"INTERNAL"in t).map(t=>t.INTERNAL.delete()),...e.filter(t=>"_delete"in t).map(t=>t._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=Gn){return this.instances.has(e)}getOptions(e=Gn){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:t={}}=e,r=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const i=this.getOrInitializeService({instanceIdentifier:r,options:t});for(const[s,a]of this.instancesDeferred.entries()){const l=this.normalizeInstanceIdentifier(s);r===l&&a.resolve(i)}return i}onInit(e,t){const r=this.normalizeInstanceIdentifier(t),i=this.onInitCallbacks.get(r)??new Set;i.add(e),this.onInitCallbacks.set(r,i);const s=this.instances.get(r);return s&&e(s,r),()=>{i.delete(e)}}invokeOnInitCallbacks(e,t){const r=this.onInitCallbacks.get(t);if(r)for(const i of r)try{i(e,t)}catch{}}getOrInitializeService({instanceIdentifier:e,options:t={}}){let r=this.instances.get(e);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:my(e),options:t}),this.instances.set(e,r),this.instancesOptions.set(e,t),this.invokeOnInitCallbacks(r,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,r)}catch{}return r||null}normalizeInstanceIdentifier(e=Gn){return this.component?this.component.multipleInstances?e:Gn:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function my(n){return n===Gn?void 0:n}function gy(n){return n.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sn=new ml("@firebase/app"),Vy="@firebase/app-compat",My="@firebase/analytics-compat",xy="@firebase/analytics",Fy="@firebase/app-check-compat",Uy="@firebase/app-check",$y="@firebase/auth",By="@firebase/auth-compat",jy="@firebase/database",Hy="@firebase/data-connect",zy="@firebase/database-compat",qy="@firebase/functions",Wy="@firebase/functions-compat",Ky="@firebase/installations",Gy="@firebase/installations-compat",Qy="@firebase/messaging",Yy="@firebase/messaging-compat",Jy="@firebase/performance",Xy="@firebase/performance-compat",Zy="@firebase/remote-config",ev="@firebase/remote-config-compat",tv="@firebase/storage",nv="@firebase/storage-compat",rv="@firebase/firestore",iv="@firebase/ai",sv="@firebase/firestore-compat",ov="firebase",av="12.2.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Da="[DEFAULT]",lv={[ka]:"fire-core",[Vy]:"fire-core-compat",[xy]:"fire-analytics",[My]:"fire-analytics-compat",[Uy]:"fire-app-check",[Fy]:"fire-app-check-compat",[$y]:"fire-auth",[By]:"fire-auth-compat",[jy]:"fire-rtdb",[Hy]:"fire-data-connect",[zy]:"fire-rtdb-compat",[qy]:"fire-fn",[Wy]:"fire-fn-compat",[Ky]:"fire-iid",[Gy]:"fire-iid-compat",[Qy]:"fire-fcm",[Yy]:"fire-fcm-compat",[Jy]:"fire-perf",[Xy]:"fire-perf-compat",[Zy]:"fire-rc",[ev]:"fire-rc-compat",[tv]:"fire-gcs",[nv]:"fire-gcs-compat",[rv]:"fire-fst",[sv]:"fire-fst-compat",[iv]:"fire-vertex","fire-js":"fire-js",[ov]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wv(n){Ur(new nr("platform-logger",e=>new Ly(e),"PRIVATE")),Ur(new nr("heartbeat",e=>new _v(e),"PRIVATE")),Sn(ka,yc,n),Sn(ka,yc,"esm2020"),Sn("fire-js","")}wv("");function Gd(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Tv=Gd,Qd=new Xi("auth","Firebase",Gd());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _f(n,e,t=!1){if(Pt(n.app))return Promise.reject(Pn(n));const r="signIn",i=await gf(n,r,e),s=await $r._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}async function _E(n,e){return _f(Jr(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yE(n){const e=Jr(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}function vE(n,e,t){return Pt(n.app)?Promise.reject(Pn(n)):_E(Tt(n),Xr.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&yE(n),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function EE(n,e){return Tt(n).setPersistence(e)}function wE(n,e,t,r){return Tt(n).onIdTokenChanged(e,t,r)}function TE(n,e,t){return Tt(n).beforeAuthStateChanged(e,t)}function yf(n,e,t,r){return Tt(n).onAuthStateChanged(e,t,r)}function IE(n){return Tt(n).signOut()}const ho="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HE="pendingRedirect",Ws=new Map;class zE extends Pf{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=Ws.get(this.auth._key());if(!e){try{const r=await qE(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}Ws.set(this.auth._key(),e)}return this.bypassAuthState||Ws.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function qE(n,e){const t=GE(e),r=KE(n);if(!await r._isAvailable())return!1;const i=await r._get(t)==="true";return await r._remove(t),i}function WE(n,e){Ws.set(n._key(),e)}function KE(n){return rn(n._redirectPersistence)}function GE(n){return qs(HE,n.config.apiKey,n.name)}async function QE(n,e,t=!1){if(Pt(n.app))return Promise.reject(Pn(n));const r=Jr(n),i=FE(r,e),a=await new zE(r,i,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Sn(FR,UR,"app");const $R={apiKey:"AIzaSyDFOBqf8hyd3aMi6iENM6RYMpl7SA-jT_U",authDomain:"database-99996.firebaseapp.com",projectId:"database-99996",storageBucket:"database-99996.firebasestorage.app",messagingSenderId:"114068892226",appId:"1:114068892226:web:04bff3a786380f48e3dbdb",measurementId:"G-1HQS26V8V6"},xp=zd($R),BR=SR(xp),Ki=Lw(xp),jR=()=>{const[n,e]=Be(!1),[t,r]=Be(""),[i,s]=Be(""),[a,l]=Be(""),u=Ao();return mt(()=>{if(a){const f=setTimeout(()=>l(""),3e3);return()=>clearTimeout(f)}},[a]),j("div",{className:"login-container",children:[a&&j("div",{className:"error-toast show",children:[j("p",{children:a}),j("button",{onClick:()=>l(""),children:"×"})]}),j("div",{className:"login-card",children:[j("div",{className:"login-left",children:[j("h1",{children:"IoTelligence"}),j("p",{children:"An IOT Data management company"})]}),j("div",{className:"login-right",children:[j("h2",{children:"Hello Again!"}),j("p",{children:"Welcome Back"}),j("form",{onSubmit:async f=>{f.preventDefault(),l(""),e(!0);try{await EE(Ki,wf),await vE(Ki,t,i),u("/",{replace:!0})}catch(p){switch(console.error("Firebase Login Error:",p),p.code){case"auth/user-not-found":l("No user found with this email.");break;case"auth/wrong-password":l("Incorrect password. Please try again.");break;case"auth/invalid-email":l("Please enter a valid email address.");break;case"auth/invalid-credential":l("Invalid email or password. Please try again.");break;case"auth/too-many-requests":l("Access to this account has been temporarily disabled due to many failed login attempts.");break;default:l("An unexpected error occurred. Please try again.");break}}finally{e(!1)}},className:"login-form",children:[j("div",{className:"form-group",children:[j("label",{htmlFor:"email",children:"Email address"}),j("input",{type:"email",id:"email",placeholder:"Email address",value:t,onChange:f=>r(f.target.value),required:!0})]}),j("div",{className:"form-group",children:[j("label",{htmlFor:"password",children:"Password"}),j("input",{type:"password",id:"password",placeholder:"Password",value:i,onChange:f=>s(f.target.value),required:!0})]}),j("button",{type:"submit",className:"login-btn",disabled:n,children:n?"Logging in...":"Login"})]})]})]})]})};function HR(n){let e=[];try{typeof n=="string"?e=JSON.parse(n):Array.isArray(n)?e=n:n!=null&&(e=[n])}catch(t){return console.error("Failed to parse sensors JSON:",t,n),[]}return e.map(t=>({sensor:t.Sensor??t.sensor??"",measurement:Number(t.Measurement??t.measurement??0),unit:t.Unit??t.unit??"",category:t.Category??t.category??""}))}const zR=(n,e)=>e==="psi"?n<100?{indicatorColor:"bg-red-500",message:"Warning: Pressure is too low"}:n<600?{indicatorColor:"bg-yellow-500",message:"Warning: Pressure is little low"}:n>2e3?{indicatorColor:"bg-red-500",message:"Warning: Pressure is too high"}:{indicatorColor:"bg-green-500",message:null}:e==="°C"?n<500?{indicatorColor:"bg-yellow-500",message:"Warning: Temperature is little low"}:n>1500?{indicatorColor:"bg-red-500",message:"Warning: Temperature is too high"}:{indicatorColor:"bg-green-500",message:null}:{indicatorColor:"bg-gray-400",message:null},qR=()=>{const[n,e]=Be([]),[t,r]=Be([]),[i,s]=Be("");mt(()=>{const l=bR(BR,"sensors","latestData"),u=MR(l,h=>{if(!h.exists()){s("No Firestore data found.");return}const f=h.data().data;if(!f||typeof f!="string"){s("Invalid Firestore data format.");return}const p=JSON.parse(f),g=HR(p.sensors);e(g.filter(v=>v.category==="Header")),r(g.filter(v=>v.category==="Separator")),s("")},h=>{console.error("❌ Firestore snapshot error:",h),s("Failed to fetch data.")});return()=>u()},[]);const a=({heading:l,sensors:u})=>j(vt,{children:j("div",{className:"mb-14 border-2 border-[#233e73]   rounded-2xl",children:[j("h2",{className:` bg-gradient-to-br from-[#2e4784] via-[#1a3765] to-[#0d1d4b]
 text-xl text-center font-bold text-white mb-4  rounded-tl-xl rounded-tr-xl pb-2`,children:l}),j("div",{className:"p-2 max-sm:p-1",children:j("div",{className:"grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 mb-6",children:u.map((h,f)=>{const{indicatorColor:p,message:g}=zR(h.measurement,h.unit);return j("div",{className:"relative cursor-pointer bg-white rounded-lg shadow-md p-3 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg  hover:outline-1 hover:outline-blue-500 outline-amber-50",children:[j("div",{className:`absolute top-2 right-2 w-4 h-4 rounded-full ${p} ring-2 ring-white`}),j("p",{className:"text-gray-500 text-xs font-medium uppercase truncate mb-1",children:h.sensor}),j("div",{className:"flex items-baseline mt-1",children:[j("span",{className:"text-xl font-extrabold text-gray-900",children:h.measurement}),j("span",{className:"ml-1 text-sm font-normal text-gray-500",children:h.unit})]}),g&&j("div",{className:"mt-2 flex items-center text-[10px] font-medium text-red-700 bg-red-100 p-1 rounded-md",children:[j("svg",{xmlns:"http://www.w3.org/2000/svg",className:"mr-1 h-3 w-3 text-red-500",viewBox:"0 0 20 20",fill:"currentColor",children:j("path",{fillRule:"evenodd",d:"M8.257 3.511a.75.75 0 011.486 0L14.73 11.2a.75.75 0 01-.664 1.155H5.934a.75.75 0 01-.664-1.155L8.257 3.511zM10 13a1 1 0 100-2 1 1 0 000 2z",clipRule:"evenodd"})}),g]})]},f)})})})]})});return j("div",{className:"min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8",children:j("div",{className:"min-w-11/12 mx-auto",children:[i&&j("p",{className:"text-red-600 font-semibold mb-6",children:i}),j(a,{heading:"Header Sensors",sensors:n}),j(a,{heading:"Separator Sensors",sensors:t})]})})},jh=({goTo:n})=>{const e=Ao();return j("div",{className:"error-container",children:j("div",{className:"error-card",children:[j("div",{className:"error-icon-wrapper",children:j("span",{className:"error-icon-text",children:"⚠️"})}),j("h1",{className:"error-title",children:"Invalid URL"}),j("p",{className:"error-message",children:"You have entered a wrong URL. Please go back to previous page."}),j("button",{onClick:()=>{e(n)},className:"error-button",children:"Go Back"})]})})},WR=()=>{const n=a=>{const l=String(a.getDate()).padStart(2,"0"),u=String(a.getMonth()+1).padStart(2,"0"),h=a.getFullYear();return`${l}-${u}-${h}`},e=a=>a.toLocaleTimeString("en-IN",{hour12:!0}),[t,r]=Be(n(new Date)),[i,s]=Be(e(new Date));return mt(()=>{const a=setInterval(()=>{const l=new Date;r(n(l)),s(e(l))},1e3);return()=>clearInterval(a)},[]),j("footer",{className:"footer",children:[j("div",{className:"footer-left",children:["© DEVELOPED BY IOTELLIGENCE SOFTWARE SOLUTIONS |"," ",j("a",{className:"footer-link",href:"tel:+919158151405",children:"+91 9158151405"})," ","| 2025"]}),j("div",{className:"footer-right",children:[j("span",{children:t}),j("span",{children:i})]})]})},KR=()=>{const[n,e]=Be(null),[t,r]=Be(!0);return mt(()=>{const i=yf(Ki,s=>{e(s),r(!1)});return()=>i()},[]),{user:n,loading:t}},GR=({children:n})=>{const{user:e,loading:t}=KR();return t?j("div",{children:"Loading..."}):e?n||j(Sd,{}):j(e_,{to:"/login",replace:!0})},QR=3e3*1e3,YR=()=>{const n=xr(null),e=xr(null),t=()=>{n.current!==null&&clearTimeout(n.current),e.current&&(n.current=setTimeout(()=>{console.log("⏳ User inactive for 1 minute. Logging out..."),IE(Ki).catch(r=>console.error("Logout error:",r))},QR))};return mt(()=>{const r=yf(Ki,i=>{e.current=i,i?(t(),document.addEventListener("mousemove",t),document.addEventListener("keypress",t),document.addEventListener("touchstart",t),document.addEventListener("click",t)):(n.current!==null&&clearTimeout(n.current),document.removeEventListener("mousemove",t),document.removeEventListener("keypress",t),document.removeEventListener("touchstart",t),document.removeEventListener("click",t))});return()=>{r(),n.current!==null&&clearTimeout(n.current),document.removeEventListener("mousemove",t),document.removeEventListener("keypress",t),document.removeEventListener("touchstart",t),document.removeEventListener("click",t)}},[]),null},JR=()=>j("div",{className:"layout",children:[j("header",{children:j(F_,{})}),j("main",{className:"content",children:[j(Sd,{})," "]}),j("footer",{children:j(WR,{})})]}),XR=()=>{YR();const n=R_([{element:j(JR,{}),children:[{path:"/",element:j(GR,{children:j(qR,{})}),errorElement:j(jh,{goTo:"/"})}]},{path:"/login",element:j(jR,{}),errorElement:j(jh,{goTo:"/login"})}]);return j(M_,{router:n})};om(j(XR,{}),document.getElementById("app"));
